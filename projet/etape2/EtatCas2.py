...
class EtatCas2(Etat) :
    ...
    def successeurs(self) :
        ...
        """ 
        successeurs = self.tg.getAdjacents(self.etat_courant)
        sommets_gardes = []
        ...
        return [EtatCas2(tg=self.tg, etat_courant=sommet, objectif=self.objectif, visite=self.visite + [sommet]) for sommet in sommets_gardes]
    ...
    def h(self) :  
        ...
        return  self.tg.getPoidsMinTerre() * (self.tg.getNbSommets() - len(self.visite))
